  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {films?.map((film: any) => {
          // hacky way to extract the ID from SWAPI url, but it works for now!
          ...
          <div 
            ...
            className="border border-sw-yellow/30 p-6 rounded-lg bg-black hover:border-sw-yellow transition-all cursor-pointer group hover:-translate-y-1 duration-300 shadow-lg shadow-sw-yellow/5"
          >
